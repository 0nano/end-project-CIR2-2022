...
function detail_match(match) {
    ...
    match.players.forEach(function (player) {
        players.innerHTML += "<div class='player card text-black'><p class='card-title'>"+player.firstname + " " + player.lastname +"</p><img class='img_player' alt='photo du joueur' src='"+player.picture+"'/></div>";
    });
